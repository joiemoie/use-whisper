export type UseWhisperConfig = {
  ...
  onDataAvailableTranscribe?: (blob: Blob, currentChunks: Blob[]) => Promise<UseWhisperTranscript>
  onTranscribe?: (blob: Blob, currentChunks: Blob[]) => Promise<UseWhisperTranscript>
}
